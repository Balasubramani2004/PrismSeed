...
export default function AuthPage() {
  ...
  const [password, setPassword] = useState(""); // login/register
  const [confirmPassword, setConfirmPassword] = useState(""); // register

  const [role, setRole] = useState("superadmin"); // login only
        ...
        >
          ...
          >
            <Box sx={{ width: "100%", maxWidth: 350 }}>
              ...
              >
                <EditOutlinedIcon sx={{ fontSize: 30, color: "primary.main" }} />
